...
var RosterService = (function () {
    function RosterService(http) {
        this.http = http;
        this.rosterUrl = '/api/rosters';
    }
    RosterService.prototype.getRosters = function () {
        return this.http.get(this.rosterUrl)
            .map(function (res) { return res.json(); })
            .catch(function (error) { return Observable_1.Observable.throw(error.json().error || "Server Error retreiving Grades"); });
    };
